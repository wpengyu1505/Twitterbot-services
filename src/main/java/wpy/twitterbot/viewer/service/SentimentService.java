...
public class SentimentService {
    ...
    public String get(String symbol, String date) throws IOException, ParseException {
        ...
        // words.add("good");
        //
        // Sentiment sentiment1 = new Sentiment("20160728195804", "Hellow
        // world1", "3.5", "4.5", words);
        // Sentiment sentiment2 = new Sentiment("20160728195805", "Hellow
        // world2", "3.5", "4.7", words);
        //
    ...
    public String getStats(String symbol) throws IOException, ParseException {

        ArrayList<DailyStats> stats = utils.getStats(symbol);
